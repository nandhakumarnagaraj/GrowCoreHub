...
public class AssessmentUtils {
	...
	public static class AssessmentBuilder {
		...
		public AssessmentBuilder addMultipleChoiceQuestion(String id, String question, List<String> options,
			...
			ObjectNode q = new QuestionBuilder(id, question, "multiple_choice").withOptions(options)
					.withCorrectAnswer(correctAnswer).withPoints(points).build();
			questions.add(q);
			return this;
		}

		public AssessmentBuilder addTrueFalseQuestion(String id, String question, boolean correctAnswer, int points) {
			ObjectNode q = new QuestionBuilder(id, question, "true_false").withCorrectAnswer(correctAnswer)
		...
		public AssessmentBuilder addNumericalQuestion(String id, String question, double correctAnswer,
			...
			ObjectNode q = new QuestionBuilder(id, question, "numerical").withCorrectAnswer(correctAnswer)
					.withTolerance(tolerance).withPoints(points).build();
			questions.add(q);
			return this;
		}

		public AssessmentBuilder addTextQuestion(String id, String question, List<String> keywords, int points) {
			ObjectNode q = new QuestionBuilder(id, question, "text").withKeywords(keywords).withPoints(points).build();
			questions.add(q);
			return this;
		}

		public AssessmentBuilder addEssayQuestion(String id, String question, int points) {
			ObjectNode q = new QuestionBuilder(id, question, "text").withPoints(points).build();
			questions.add(q);
			return this;
		}
